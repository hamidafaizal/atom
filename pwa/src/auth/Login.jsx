...
// Login.jsx: Halaman untuk autentikasi pengguna PWA
export default function Login({ setActivePage }) {
  ...
  console.log('Halaman Login PWA dirender.'); // log untuk debugging
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    setError('');
    console.log('Mencoba login PWA dengan email:', email); // log untuk debugging
    ...
    if (error) {
      console.error('Error login PWA:', error.message); // log untuk debugging
      setError(error.message);
    } else {
      console.log('Login PWA berhasil.'); // log untuk debugging
